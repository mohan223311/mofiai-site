...
function FloatingIconCluster() {
  const icons = [
    { Icon: Bot, label: "Chatbots", color: "#60a5fa", x: "10%", y: "5%" },
    { Icon: Mic, label: "Voice", color: "#a78bfa", x: "70%", y: "12%" },
    { Icon: Settings2, label: "Workflows", color: "#34d399", x: "0%", y: "55%" },
    { Icon: MessageSquare, label: "WhatsApp", color: "#22c55e", x: "75%", y: "60%" },
    { Icon: MapIcon, label: "Scraping", color: "#fb923c", x: "15%", y: "85%" },
    { Icon: Link2, label: "APIs", color: "#f472b6", x: "65%", y: "85%" },
  ];
  return (
    <>
      <motion.div
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-32 w-32 rounded-2xl flex items-center justify-center font-display text-2xl text-white shadow-2xl"
      ...
      {icons.map(({ Icon, label, color, x, y }, i) => (
        ...
        >
          <div className="h-14 w-14 rounded-xl flex items-center justify-center backdrop-blur"
